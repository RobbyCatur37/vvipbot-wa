...
const BotName ROBBY CATUR V 2.0'; 
const instagram = 'robbycatur_3784'; 
const aktif = 'Kapan bot aktif';
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            + 'VERSION:3.0\n' 
            + 'FN:Robby Catur' // Nama kamu
            + 'ORG:ROBBY CATUR V 2.0 ;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=6282245409072:+62 822-4540-9072\n' //Nomor whatsapp kamu
            + 'END:VCARD'
const
{
WAConnection,
